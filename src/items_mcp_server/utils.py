...
def retrieve_item_data(query: str, k: int = 5) -> Dict[str, List]:
    """Retrieve product items using hybrid search with semantic and BM25 fusion."""
...
def process_item_context(context: Dict[str, List]) -> str:
